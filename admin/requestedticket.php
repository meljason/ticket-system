                        ...
                        <form action="" method="post">
                            <table class="table table-striped">
                                ...
                                foreach ($tickets->ticket as $ticket) {
                                    if (isset($_SESSION['email']) && $ticket->attributes()->status == 'requested') {
                                        echo '<tr>
                                                <td>' . $ticket->userEmail . '</td>
                                                <td>' . $ticket->title . '</td>
                                                <td>' . $ticket->supportMessage . '</td>
                                                <td>' . $ticket->attributes()->status . '</td>
                                                <td><button type="submit" class="btn btn-dark"  name="' . $ticket->id . '">Take</button></td>
                                            </tr>';
                                    }
                                }
                                ?>
